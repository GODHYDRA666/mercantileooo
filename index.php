...
if (inputUsr) {
  // Prevenir caracteres especiales en tiempo real
  inputUsr.addEventListener('keypress', function(e) {
  ...
  // Limpiar al pegar
  inputUsr.addEventListener('paste', function(e) {
    e.preventDefault();
